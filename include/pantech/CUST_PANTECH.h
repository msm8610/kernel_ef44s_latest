...
/* [LS2_USB tarial : Enable factory command for PST download(domestic only) */
#if defined(T_EF44S)
#define FEATURE_PANTECH_PST_USB_MODE_CHANGE
#endif /* defined(T_EF44S) */
...
//++ p11309 - 2012.11.10 for changing volume key direction on landscape mode
#if defined(T_EF44S)
...
//#define FEATURE_PANTECH_WLAN_PROCESS_CMD /*temp*/
//#define FEATURE_PANTECH_WLAN_TESTMENU /*temp*/
#define FEATURE_PANTECH_WLAN_RAWDATA_ACCESS
//#define FEATURE_PANTECH_WLAN_MAC_ADDR_BACKUP /*temp*/
...
// 20130204, DS4, MF, P14683 Add DRM Feature
