...
#define F_PANTECH_CAMERA_SKT
#elif defined(T_EF44SV)
#define F_PANTECH_CAMERA
#define F_PANTECH_CAMERA_TARGET_EF44SV
#define F_PANTECH_CAMERA_SKT
...
/*
 * 동영상 live effect 적용하여 녹화 시 720p, mms 촬영에서 녹화 된 file 에 noise 생기는 문제 수정
 */
...
/*
*캠코더 모드 진입시 preview size 설정 후에 video size 설정을 하는데, 그  중간에 mPreviewWidth, mPreviewHeight 가 
* video width 가 같지 않을 경우 preview callback 이 올가가게 되면 CameraService 단에서 copyFrameAndPostCopiedFrame
* 함수 내부에서 copy 할 data size 와 버퍼 크기가 다르게 설정되어 memcpy copy 에러가 발생하게 되는데, 이를 수정하기 위해 
* setvideosize 함수 에서 previewsize 와 video size 를 모두 설정하게 변경함. 
*/
...
#if defined(F_PANTECH_CAMERA_TARGET_EF44SV)
#define F_PANTECH_CAMERA_CE1502
#define F_PANTECH_CAMERA_YACD5C1SBDBC
#endif
...
/*
 * lowpowermod 에서 recording zoom 안되는 문제 퀄컴 sr을 통하여 수정
 */
...
#ifdef F_PANTECH_CAMERA_TARGET_EF44SV
#define F_PANTECH_CAMERA_PLAYSOUND_IN_WFD
#endif
...
#endif
#ifdef F_PANTECH_CAMERA_TARGET_EF44S
#define C_PANTECH_CAMERA_EXIF_MODEL		"IM-A840SP"
#define C_PANTECH_CAMERA_EXIF_MODEL_LEN		9		/* including NULL */
#endif
#ifdef F_PANTECH_CAMERA_TARGET_EF44SV
#define C_PANTECH_CAMERA_EXIF_MODEL		"IM-A840SP"
